...
pub fn get(r: &Rustunl, endpoint: &str) -> Response {
    let req = format_request(r, endpoint, RequestVerb::Get, "");
    send_request(r, req)
}

pub fn post(r: &Rustunl, endpoint: &str, json_body: &str) -> Response {
    let req = format_request(r, endpoint, RequestVerb::Post, json_body);
    send_request(r, req)
}

fn format_request(r: &Rustunl, endpoint: &str, method: RequestVerb, body: &str) -> String {
    match method {
...
fn send_request(r: &Rustunl, req: String) -> Response {
